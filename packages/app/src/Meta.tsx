...
export const Meta = ({ metadata }: Props) => {
  const meta = metadata ? metadata : defaults;
  return (
    <Head>
      <meta
        key="viewport"
      ...
      <meta
        name="twitter:site"
        content={
          meta.twitterHandle ? meta.twitterHandle : defaults.twitterHandle
        }
      />
      <meta
      ...
      <meta
        property="og:type"
        content={meta.type ? meta.type : defaults.type}
      />
      <meta
